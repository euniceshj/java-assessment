...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        //TODO 1. Get and Print out student's enrolledCourses
        // 2. prompt for input of course to be graded, use scanner
        // 3. sout "Insert course grade for: (name of course)
        // 4. prompt for input of grade score.
        System.out.println(student.getEnrolledCourses());
        System.out.println( "\nInsert course ID to be graded:" );
        String courseId = scanner.next();
        ...
        studentService.addGradesToCourse(courseId, grade);
    }
